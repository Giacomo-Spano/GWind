 ...
 */
public class RecyclerMeteoCardListFragment extends Fragment implements OnStartDragListener {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerMeteoCardListAdapter adapter = new RecyclerMeteoCardListAdapter(getActivity(), this);
