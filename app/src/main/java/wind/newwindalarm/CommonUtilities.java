...
public final class CommonUtilities {
     ...
     */
    static final String SERVER_URL = "http://192.168.1.103:8080/mycgmserver";
	//static final String SERVER_URL = "http://myapp2-giacomohome.rhcloud.com/mycgmserver";
   

    /**
     * Google API project id registered to use GCM.
     */
    static final String SENDER_ID = "967167304447";
    ...
    static final String EXTRA_NOTIFICATIONTYPE = "notificationType";
